...
GET_SERVICES() {
  # if anything other than 1-5 is selected, display error message.
  if [[ $1 ]]
  then
    echo -e "\n$1"
  fi
  ...
  case $SERVICE_ID_SELECTED in
    # Condition 1: 1-5, go to the next function
    [1-5]) GET_PHONE_NUMBER ;;
    # Condition 2: does not match pattern 1-5, call function and pass argument
